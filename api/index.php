...
/* --- API Classes ---------------------- */
require_once WWW_ROOT. "api" .DIRECTORY_SEPARATOR. 'bands.php';
require_once WWW_ROOT. "api" .DIRECTORY_SEPARATOR. 'bandBattles.php';
require_once WWW_ROOT. "api" .DIRECTORY_SEPARATOR. 'bandImages.php';
require_once WWW_ROOT. "api" .DIRECTORY_SEPARATOR. 'bandRatings.php';
